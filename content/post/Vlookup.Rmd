...
##The slow way you want to avoid
...
3. Now copy and paste the entire content of the file from SCANEXAM to a new sheet in the same workbook as the gradebook file, and name it 'Sheet1'. ![](/post/Vlookup_files/2sheet.png){width=80%}
